...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.nafi.camera_picker.CameraPickerPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin camera_picker, com.nafi.camera_picker.CameraPickerPlugin", e);
    }
    try {
